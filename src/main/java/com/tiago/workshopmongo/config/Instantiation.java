...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("07/06/2021"),"Let's go", "Lets go to Amsterdam",maria);
		Post post2 = new Post(null, sdf.parse("02/06/2021"),"Ces't parti", "Ces't parti pour Amsterdam",maria);
